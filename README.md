...
Install via pip:
```
pip install git+https://github.com/AlexandreHutton/pyPsupertime.git
```
...
----------
* Version 2.2.0:
    - Updated to be compatible with scikit-learn~1.8. Added docstrings, requirements, and updated pyproject.toml.
